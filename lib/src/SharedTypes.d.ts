...
export declare type LoggerOnResponsePayload = LoggerOnResponseResponse | LoggerOnResponseError;
export declare type LoggerOnResponseCallback = (payload: LoggerOnResponsePayload) => void;
